 ...
 * =============================================================================
 *
 *       Filename:  list_objects_with_prefix.cc
 *
...
/**
* 返回请求者指定Bucket下前缀为prefix的所有Object的列表
*/
...
int main()
{
	...
	const string prefix = "fun";

	ObjectListing object_listing = client.ListObjects(bucket_name, prefix, retcode);
	cout << "list_objects_with_bucket_name result:" << endl << endl;
	if(retcode == 0) {
		cout << "list_objects_with_bucket_name successfully." << endl;
		cout << "bucket_name = " << object_listing.bucket_name() << endl << "next_marker = " << object_listing.next_marker() << endl << "prefix = " << object_listing.prefix() << endl << "marker = " << object_listing.marker() << endl << "max_keys = " << object_listing.max_keys() << endl << "delimiter = " << object_listing.delimiter() << endl << "is_truncated = " << object_listing.is_truncated() << endl; 

...
/**
 * @defgroup GetObjectRequest GetObjectRequest
 * @{
 */
...
class GetObjectRequest {
	...
	private :
		...
		GetObjectRequest(const GetObjectRequest&);
		void operator=(const GetObjectRequest&);

	public :
		/**
		 * GetObjectRequest构造函数
		 * @param bucket_name [in] Bucket名称
		 * @param key [in] Object名称
		 */
		GetObjectRequest(const string &bucket_name,
				const string &key)
		{
